...
OPTIONS = -lnetworkit -lboost_serialization -lboost_program_options -lboost_system -lboost_filesystem -fopenmp -lboost_timer -lpython3.6m
INCLUDEPATH = /home/mainuser/.local/lib/python3.6/site-packages/include/ -I/usr/include/valgrind -I/usr/include/python3.6m/
PATHLIB = /home/mainuser/.local/lib/python3.6/site-packages/include/
